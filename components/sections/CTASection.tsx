      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 relative z-10">
        <motion.div style={{ scale, opacity }}>
          ...
          <div className="text-center mb-16">
            {['МЫ ДЕЛАЕМ НОСКИ', 'КОТОРЫЕ НОСЯТ', 'ЛЮДИ'].map((line, i) => (
              <div key={line} className="overflow-hidden">
                <motion.p
                  ...
                  style={{
                    ...
                    color: i === 2 ? 'transparent' : i === 1 ? 'rgba(255,255,255,0.9)' : 'rgba(255,255,255,0.3)',
                    background: i === 2 ? 'linear-gradient(135deg,#E94560,#F5A623)' : undefined,
          ...
          >
            {TRUST.map((t) => (
              <span key={t} className="hover:text-white/50 transition-colors">
                {t}
              </span>
            ))}
          </motion.div>
